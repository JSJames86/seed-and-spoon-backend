...
// This script seeds the database with Hudson County food bank data
// Usage: node scripts/seed-hudson.js
...
async function seedHudsonData() {
  try {
    console.log('🌱 Seeding Hudson County Food Bank Data\n')

    // Read the CSV file
    const csvPath = './data/hudson-county-food-banks.csv'
    ...
    const serviceCounts = {}
    data.forEach(fb => {
      const service = fb.service_type || 'Unknown'
