...
// This script seeds the database with Union County food bank data
// Usage: node scripts/seed-union.js
...
async function seedUnionData() {
  try {
    console.log('🌱 Seeding Union County Food Bank Data\n')

    // Read the CSV file
    const csvPath = './data/union-county-food-banks.csv'
